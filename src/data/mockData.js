...
export const HPO_DIAG = {
  ...
  conversation: [
    ...
    { from: "user", text: "构音障碍先出现，约 8 个月前；震颤是 5 个月后出现的。", chosen: "构音障碍先出现" },
    {
      ...
      choices: ["静止时明显，动作时减轻", "动作时加重，静止时消失", "静止与动作时均明显"],
    },
...
export const HPO_CATALOG = [
  { id: "HP:0001300", label: "锥体外系症状", labelEn: "Extrapyramidal sign" },
  { id: "HP:0001260", label: "构音障碍", labelEn: "Dysarthria" },
  { id: "HP:0001397", label: "肝脂肪变性", labelEn: "Hepatic steatosis" },
  { id: "HP:0200136", label: "Kayser-Fleischer 环", labelEn: "Kayser-Fleischer ring" },
  { id: "HP:0002172", label: "肢体僵硬", labelEn: "Limb rigidity" },
  { id: "HP:0000718", label: "攻击行为", labelEn: "Aggressive behavior" },
  { id: "HP:0001250", label: "癫痫发作", labelEn: "Seizures" },
  { id: "HP:0001263", label: "全面性发育迟缓", labelEn: "Global developmental delay" },
  { id: "HP:0001290", label: "肌张力低下", labelEn: "Hypotonia" },
  { id: "HP:0001324", label: "肌无力", labelEn: "Muscle weakness" },
  { id: "HP:0001382", label: "关节过度活动", labelEn: "Joint hypermobility" },
  { id: "HP:0001510", label: "生长迟缓", labelEn: "Growth delay" },
  { id: "HP:0001519", label: "蜘蛛指(趾)", labelEn: "Arachnodactyly" },
  { id: "HP:0001638", label: "心肌病", labelEn: "Cardiomyopathy" },
  { id: "HP:0001873", label: "血小板减少", labelEn: "Thrombocytopenia" },
  { id: "HP:0002027", label: "腹痛", labelEn: "Abdominal pain" },
  { id: "HP:0002059", label: "脑萎缩", labelEn: "Cerebral atrophy" },
  { id: "HP:0002072", label: "舞蹈样动作", labelEn: "Chorea" },
  { id: "HP:0002094", label: "呼吸困难", labelEn: "Dyspnea" },
  { id: "HP:0002315", label: "头痛", labelEn: "Headache" },
  { id: "HP:0002493", label: "上运动神经元损害", labelEn: "Upper motor neuron dysfunction" },
  { id: "HP:0002659", label: "反复骨折", labelEn: "Recurrent fractures" },
  { id: "HP:0003236", label: "血清 CK 升高", labelEn: "Elevated serum CK" },
  { id: "HP:0003323", label: "进行性肌无力", labelEn: "Progressive muscle weakness" },
  { id: "HP:0004322", label: "身材矮小", labelEn: "Short stature" },
  { id: "HP:0007957", label: "角膜混浊", labelEn: "Corneal opacity" },
  { id: "HP:0000365", label: "听力下降", labelEn: "Hearing loss" },
  { id: "HP:0000496", label: "眼球运动异常", labelEn: "Abnormal eye movement" },
  { id: "HP:0000580", label: "视网膜色素变性", labelEn: "Retinal degeneration" },
  { id: "HP:0000592", label: "蓝巩膜", labelEn: "Blue sclerae" },
  { id: "HP:0000662", label: "夜盲症", labelEn: "Nyctalopia" },
  { id: "HP:0000750", label: "语言发育迟缓", labelEn: "Delayed speech" },
  { id: "HP:0000975", label: "皮肤过度伸展", labelEn: "Hyperextensible skin" },
  { id: "HP:0000992", label: "皮肤光敏感", labelEn: "Photosensitivity" },
  { id: "HP:0001010", label: "皮肤色素减退", labelEn: "Hypopigmentation" },
  { id: "HP:0001047", label: "特应性皮炎", labelEn: "Atopic dermatitis" },
  { id: "HP:0001083", label: "晶状体脱位", labelEn: "Ectopia lentis" },
  { id: "HP:0001133", label: "视野缩窄", labelEn: "Constriction of visual field" },
  { id: "HP:0001249", label: "智力障碍", labelEn: "Intellectual disability" },
  { id: "HP:0001251", label: "小脑性共济失调", labelEn: "Cerebellar ataxia" },
  { id: "HP:0001271", label: "多发性神经病", labelEn: "Polyneuropathy" },
  { id: "HP:0001373", label: "关节脱位", labelEn: "Joint dislocation" },
  { id: "HP:0001627", label: "先天性心脏病", labelEn: "Congenital heart defect" },
  { id: "HP:0001631", label: "房间隔缺损", labelEn: "Atrial septal defect" },
  { id: "HP:0002061", label: "痉挛性截瘫", labelEn: "Spastic paraplegia" },
  { id: "HP:0002719", label: "反复感染", labelEn: "Recurrent infections" },
  { id: "HP:0003199", label: "肌疲劳", labelEn: "Muscle fatigue" },
  { id: "HP:0003391", label: "Gowers 征", labelEn: "Gowers sign" },
  { id: "HP:0003473", label: "疲劳性肌无力", labelEn: "Fatigable weakness" },
  { id: "HP:0003707", label: "腓肠肌假性肥大", labelEn: "Pseudohypertrophy of calves" },
  { id: "HP:0040315", label: "尿液变色", labelEn: "Abnormal urine color" },
]
...
export const HPO_RUNNING = {
  stage1: {
    questions: [
      ...
      {
        id: "q2",
        text: "明白。震颤属于哪些类型？（可多选）",
        reason: "静止性震颤提示锥体外系（帕金森样）受累；动作性震颤更多见于小脑病变，两者鉴别方向不同。",
        qtype: "multi",
        choices: ["静止性震颤", "动作性震颤（持物/写字时加重）", "意向性震颤（接近目标时加重）"],
        refs: [],
      },
      {
        id: "q3",
        ...
        reason: "K-F 环是 Wilson Disease 神经型的标志性体征，特异性 > 95%，阳性可大幅提升诊断权重。",
        qtype: "single",
        choices: ["已查，报告阳性 / 疑似阳性", "已查，报告阴性", "尚未检查", "不确定"],
        refs: [{ n: 1, label: "EASL Guidelines 2012" }],
      },
      {
        id: "q4",
        text: "患者肝功能检查结果如何？请描述具体数值或异常情况（如有）。",
        reason: "肝酶异常联合神经症状是 Wilson 病的典型双重表现，有助于缩小鉴别诊断范围。",
        qtype: "text",
        refs: [],
      },
      {
        id: "q5",
        text: "患者目前的日常生活能力受限情况如何？哪些活动受到影响？（可多选）",
        reason: "功能受损程度影响疾病分期判断，与治疗优先级直接相关。",
        qtype: "multi",
        choices: ["书写困难", "言语表达障碍", "吞咽功能下降", "行走步态异常", "认知 / 情绪改变"],
        refs: [],
      },
    ],
    suggestions: [
