...
export const HPO_DIAG = {
  ...
  conversation: [
    { from: "ai",   text: "您好，我是 DeepRare 诊断助手。根据您输入的病历，患者主诉为构音障碍与震颤。能否告诉我症状出现的先后顺序？" },
    { from: "user", text: "构音障碍先出现，约 8 个月前；震颤是 5 个月后出现的。" },
    { from: "ai",   text: "明白。震颤属于静止性还是动作性？是否在握物时加重？" },
    { from: "user", text: "静止时可见，写字或拿筷子时更明显。" },
    { from: "ai",   text: "请问患者是否接受过眼科裂隙灯检查？角膜周围是否存在棕色色素环（K-F 环）？" },
    { from: "user", text: "眼科看过，报告写疑似 K-F 环。" },
    { from: "ai",   text: "患者家族中是否有不明原因肝病或早期肝硬化史？" },
    { from: "user", text: "父方叔叔 42 岁因肝硬化去世，具体病因不详。外祖母有不明原因肝病史。" },
    { from: "ai",   text: "信息已收集完毕，共完成 4 轮追问，已提取 6 个 HPO 表型用于推理。" },
  ],
  hpoList: [
    { id: "HP:0001300", label: "锥体外系症状 (震颤)" },
    { id: "HP:0001260", label: "构音障碍" },
  ...
  top5: [
    ...
    { rank: 5, name: "Dopa-Responsive Dystonia", nameCn: "多巴反应性肌张力障碍", omim: "OMIM:128230", match: 27.3, conf: 31, level: "low", gene: "GCH1", inherit: "AD", summary: "日间波动性肌张力障碍, 低剂量左旋多巴显著有效。" },
  ],
  top1Match: [
  ...
  primary: [
    {
      ...
      criteria: [
        { code: "PS1", hit: true,  text: "同一氨基酸变化已有致病报告 (c.2333G>A)", weight: 2 },
        { code: "PM1", hit: true,  text: "位于跨膜域 TM4 (功能关键区)", weight: 1 },
        { code: "PM2", hit: true,  text: "gnomAD 频率 0.0008% (极罕见)", weight: 1 },
        { code: "PM5", hit: true,  text: "同位点其他错义变异已致病 p.Arg778Gln", weight: 1 },
        { code: "PP3", hit: true,  text: "多工具预测有害 (SIFT/PolyPhen/CADD)", weight: 1 },
        { code: "PP5", hit: false, text: "ClinVar 报告, 但证据等级未达 PP5", weight: 0 },
        { code: "BS1", hit: false, text: "—", weight: 0 },
      ],
      predictions: [
